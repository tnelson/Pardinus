...
public class KKTemporalUnitTesting {
...
/*
    ...
    public final void declaration_one() {
        ...
        assertEquals(addTimeToFormula.convert(initial).toString(),result);
    ...
    public final void simple_post_init() {
        ...
        Formula f = addTimeToFormula.convert(initial);
    ...
    public final void simple_always() {
        Variable var3 = Variable.unary("p");
        Formula initial = var3.in(toSend.join(var3)).and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_historically() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).historically();
    ...
    public final void simple_release() {
        Variable var3 = Variable.unary("p");
        Formula initial =  toSend.join(var3).eq(toSend.join(var3)).release(Process.join(toSend).lone()).forAll(var3.oneOf(Process));
    ...
    public final void simple_release_post() {
        Variable var3 = Variable.unary("p");
        Formula initial =  toSend.join(var3).eq(toSend.join(var3)).release(Process.join(toSend.post()).lone()).forAll(var3.oneOf(Process));
   ...
   @Test
    public final void simple_always_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).always().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_always_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).always().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_once_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).once().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_historically_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).historically().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_next_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).next().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_previous_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).previous().and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
        String result = "(one loop && (all t0: one (init . *nextt) | (all p: one Process | ((some (t0 . ~nextt) && (p in ((toSend . (t0 . ~nextt)) . p))) && (p in ((toSend . t0) . p))))))";
        assertEquals(addTimeToFormula.convert(initial).toString(),result);
    }
    ...
    public final void simple_previous_always_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).previous().and(var3.in(toSend.join(var3)).always().and(var3.in(toSend.join(var3)))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_next_eventually_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).next().and(var3.in(toSend.join(var3)).eventually().and(var3.in(toSend.join(var3)))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_until_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  Process.join(toSend).some().until(var3.in(toSend.join(var3))).and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_always_until_eventually() {
        Variable var3 = Variable.unary("p");
        Formula initial =  var3.in(toSend.join(var3)).always().and(Process.join(toSend).some().until(var3.in(toSend.join(var3)))).forAll(var3.oneOf(Process)).eventually();
    ...
    public final void simple_release_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  toSend.join(var3).eq(toSend.join(var3)).release(Process.join(toSend).lone()).forAll(var3.oneOf(Process)).always();
    ...
    public final void simple_until1_always() {
        Variable var3 = Variable.unary("p");
        Formula initial =  Process.join(toSend).some().until(var3.in(toSend.post().join(var3)).always()).and(var3.in(toSend.join(var3))).forAll(var3.oneOf(Process));
    ...
    public final void nested_quantifiers2() {
        Formula initial = ((toSend.join(toSend.post())).post().in(toSend)).and(toSend.post().post().post().in(toSend)).eventually();
        String result = "";
        assertEquals(addTimeToFormula.convert(initial).toString(),result);
    }
