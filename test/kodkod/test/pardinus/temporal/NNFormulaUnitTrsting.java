 ...
 */
public class NNFormulaUnitTrsting {
    ...
    public final void test27() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.and(new Formula[]{C.join(v).some().or(B.lone()).next(),A.lone().implies(B.some()),B.lone().not()}).not();
    ...
    public final void test28() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.and(new Formula[]{C.join(v).some().or(B.lone()).next(),A.lone().implies(B.some()),B.lone()}).not();
        String result = "(next((!some (C . v) && !lone B)) || (lone A && !some B) || !lone B)";
        assertEquals(initial.accept(nnf).toString(),result);
    }
    ...
    public final void test29() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.and(new Formula[]{C.join(v).some().and(B.lone()).next().not(),A.lone().implies(B.some()),B.lone().not()}).not();
        String result = "(next((some (C . v) && lone B)) || (lone A && !some B) || lone B)";
        assertEquals(initial.accept(nnf).toString(),result);
    }
    ...
    public final void test30() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.and(new Formula[]{C.join(v).some().and(B.lone()).next(),A.lone().implies(B.some()),B.lone()}).not();
        String result = "(next((!some (C . v) || !lone B)) || (lone A && !some B) || !lone B)";
        assertEquals(initial.accept(nnf).toString(),result);
    }
    ...
    public final void test31() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.or(new Formula[]{C.join(v).some().and(B.lone()).always(), A.lone().not().implies(B.some()), B.lone()}).not();
    ...
    public final void test33() {
        Variable v = Variable.unary("v");
        Formula initial = Formula.and(new Formula[]{C.join(v).some().or(B.lone()).previous(),A.lone().implies(B.some()),B.lone().not()}).not();
    ...
    public final void test34() {
        ...
        Formula initial = toSend.join(var3).eq(toSend.join(var3)).release(Process.join(toSend.post()).lone()).forAll(var3.oneOf(Process)).not();
    ...
    public final void test35() {
        Variable var3 = Variable.unary("p");
        Formula initial = toSend.join(var3).eq(toSend.join(var3)).until(Process.join(toSend.post()).lone()).forAll(var3.oneOf(Process)).not();
    ...
    public final void test36() {
        Variable var3 = Variable.unary("p");
        Formula initial = toSend.join(var3).eq(toSend.join(var3)).and(Process.join(toSend.post()).one()).until(Process.join(toSend.post()).lone()).forAll(var3.oneOf(Process)).not();
    ...
    public final void test37() {
        Variable var3 = Variable.unary("p");
        Formula initial = toSend.join(var3).eq(toSend.join(var3)).and(Process.join(toSend.post()).one()).until(Process.join(toSend.post()).lone()).not();
